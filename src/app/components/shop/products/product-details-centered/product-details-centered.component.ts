...
import { ProductZoomCenteredComponent } from './product-zoom/product-zoom.component';
...
export class ProductDetailsCenteredComponent implements OnInit {
  ...
  public openProductDialog(product, bigProductImageIndex) {
    let dialogRef = this.dialog.open(ProductZoomCenteredComponent, {
...
public openZoomViewer(){
  this.dialog.open(ProductZoomCenteredComponent, {
    data: this.zoomImage,
